...
namespace LAB7
{
    public partial class blank : Form
    {
        public blank()
        {
            ...
            tsTime.Text = Convert.ToString(System.DateTime.Now.ToLongTimeString());
            timer1.Interval = 1000; // Встановіть інтервал таймера на 1000 мілісекунд (1 секунда)
            timer1.Start(); // Запустіть таймер один раз
        ...
        private void richTextBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            tsAmount.Text = "Symbols: " + richTextBox1.Text.Length.ToString();
        }

        private void timer1_Tick(object sender, EventArgs e)
        {
            tsTime.ToolTipText = DateTime.Now.ToLongTimeString();
        }
    }
}
